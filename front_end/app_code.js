var updateView = async (button) => {
    if (button.dataset.querytype == 'by_instructor') {
        ...
        api = `http://localhost:PORT/api/combined_query/${combinedIns}/${combinedLev}`;
    }
